...
public protocol ViperModuleTransitionHandler: class {
    ...
    func createEmbeddableModuleUsingFactory(_ moduleFactory: ViperModuleFactory, configurationBlock: EmbeddedModuleConfigurationBlock, lazzyAllocation: Bool)
    // Shorter version of 'createEmbeddableModuleUsingFactory' where lazyAllocation is false
    func createEmbeddableModuleUsingFactory(_ moduleFactory: ViperModuleFactory, configurationBlock: EmbeddedModuleConfigurationBlock)
